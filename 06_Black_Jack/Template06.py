...
CARD_SIZE = (73, 98)
CARD_CENTER = (36.5, 49)
card_image = simplegui.load_image("http://commondatastorage.googleapiccom/codeskulptor-assetss/cards.jfitz.png")
...
class Card:
    ...
    def draw(self, canvas, pos):
        card_loc = (CARD_CENTER[0] + CARD_SIZE[0] * RANKS.index(self.rank),
                    CARD_CENTER[1] + CARD_SZIE[1] * SUITS.index(self.suit))
...
class Hand:
    ...
    # count aces as 1, if the hand has an ace, then add 10 to hand value if it doe not bust.
    def get_value(self):
        pass # replace with your code
...
class Deck:
    ...
    # add cards bck to deck and shuffle
    def shuffle(self):
        pass # replace with your code
